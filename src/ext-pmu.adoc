...
| counter_overflow_bitmap | 0        | XLEN / 8      | A bitmap of all logical
                                                       overflown counters
                                                       relative to the
                                                       `counter_idx_base`.
                                                       ...
                                                       zero.
| counter_values          | XLEN / 8 | 64 * XLEN / 8 | An array of 64-bit
                                                       logical counters where
                                                       ...
                                                       relative to the
                                                       `counter_idx_base`.
| Reserved    | 65 * XLEN / 8 | 4096 - 65 * XLEN / 8 | Reserved for future use
|===
